object ProjectConfig {
    const val PROJECT_NAMESPACE = "com.ericwathome.currencybuddy"
    const val DATA_NAMESPACE = "tech.ericwathome.data"
    const val DOMAIN_NAMESPACE = "tech.ericwathome.domain"
